...
#sign value to decide the turn of which player
sign = 0
...
#GUI of the game board for play along with another player
...
#Creating the GUI of The Game for play along with the system
...
#Intialise the gameboard to play with pc
...
#Intialise the game board to play with another player
...
def play():
      ...
      B2 = Button(menu, text="Multi Player", command=wp1, activeforeground='red', activebackground='yellow', bg='red', fg='yellow', width=500, font='summer', bd=5)

      B3 = Button(menu, text="Exit", command=wpc, activeforeground='red', activebackground='yellow', bg='red', fg='yellow', width=500, font='summer', bd=5)
      head.pack(side='top')
      B1.pack(side='top')
      B2.pack(side='top')
      B3.pack(side='top')
